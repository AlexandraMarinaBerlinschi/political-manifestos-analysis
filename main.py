...
from analysis.Word2VecAnalysis import (
    create_doc2vec_model,
    analyze_document_similarity,
    find_party_specific_vocabulary_doc2vec,
    find_word_in_manifestos_doc2vec
)
...
def main():
    ...
    #Word2Vec Analysis
    model, doc_vectors = create_doc2vec_model(manifesto_corpus)

    d2v_similarity_df = analyze_document_similarity(doc_vectors, party_names)
    print("\nDoc2Vec Document Similarity Matrix:")
    print(d2v_similarity_df)

    print("\nAnalyzing distinctive vocabulary (Doc2Vec):")
    find_party_specific_vocabulary_doc2vec(model, manifesto_corpus, party_names)
    ...
    while True:
        ...
        find_word_in_manifestos_doc2vec(search_word, model, manifesto_data, manifesto_corpus)
